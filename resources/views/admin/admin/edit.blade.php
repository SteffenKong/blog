...
@section('content')
    ...
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">管理员模块</strong> / <small>编辑管理员</small></div>
        </div>
        ...
        <form class="am-form am-form-horizontal" style="width:900px;" onsubmit="return false;">
            <div class="am-form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" id="account" name="account" required value="{{$admin['account']}}" placeholder="输入你的账号">
                </div>
            </div>
            ...
            <div class="am-form-group">
                ...
                <div class="col-sm-10">
                    <input type="email" id="email" name="email" required value="{{$admin['email']}}" placeholder="输入你的邮箱">
                </div>
            </div>
            ...
            <div class="am-form-group">
                ...
                <div class="col-sm-10">
                    <input type="tel" id="phone" name="phone" required value="{{$admin['phone']}}" placeholder="输入你的电话号码">
            ...
            <div class="am-form-group">
                ...
                <label class="am-checkbox-inline">
                    <input type="checkbox" name="status" @if($admin['status'] == 1) checked="checked" @endif value="1" style="height:20px; width:20px; margin-right:5px;"> 启用
                </label>
            </div>
        </form>
