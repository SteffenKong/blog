 ...
 * Generated for Laravel 5.8.35 on 2019-12-04 15:23:22.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class App {
         ...
         * 
         * `has($id)` returning true does not mean that `get($id)` will not throw an Exceptions.
    ...
    class Auth {
        ...
        /**
         * Determine if current user is authenticated. If not, throw an Exceptions.
         *
         * @return \App\User 
    ...
    class Queue {
        ...
        /**
         * Register an event listener for the Exceptions occurred job event.
         *
         * @param mixed $callback
         * @return void 
         * @static 
...
namespace  { 
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model {         
            ...
            /**
             * Find a model by its primary key or throw an Exceptions.
             *
             * @param mixed $id
             * @param array $columns
            ...
            /**
             * Execute the query and get the first result or throw an Exceptions.
             *
             * @param array $columns
             * @return \Illuminate\Database\Eloquent\Model|static 
             * @throws \Illuminate\Database\Eloquent\ModelNotFoundException
